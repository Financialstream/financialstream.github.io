  ...
  const i18n = {
    en: {
      ...
      hero: {
        ...
        body: 'Financial Stream LLC helps small businesses and individuals keep clean books, stay compliant, and feel confident in their numbers. We handle monthly bookkeeping in QuickBooks Online, support WA Department of Revenue and L&I matters, and prepare and file business and personal tax returns. If you’re starting a business, catching up on backlog, or getting ready for year-end — we’ll organize everything and keep it simple. Most work is done remotely, so you don’t need to visit an office.',
      ...
      services: {
        ...
        s4: { title: 'Sales Tax Support (WA DOR)', text: 'Filing support, notices, and compliance help with Department of Revenue.' },
        s5: { title: 'L&I Support (Washington)', text: 'Guidance with reporting, documentation, and communication with L&I.' },
      ...
      faq: {
        ...
        q5: { q: 'Do you help with sales tax?', a: 'Yes. We support sales tax tracking, filings, and notices (including WA Department of Revenue when applicable).' },
        q6: { q: 'Do you help with WA Department of Revenue and L&I?', a: 'Yes. We can help with reporting, notices, documentation, and communication so you stay compliant.' },
    ...
    ru: {
      ...
      services: {
        ...
        s4: { title: 'Sales Tax (WA Department of Revenue)', text: 'Помощь с подачей, уведомлениями и соблюдением требований DOR.' },
        s5: { title: 'Поддержка L&I (Washington)', text: 'Отчётность, документы и коммуникации по вопросам L&I.' },
...
monthly: {
      ...
      faq: {
        ...
        q5: { q: 'Вы помогаете с sales tax?', a: 'Да. Помогаем с учётом, подачей и уведомлениями (включая WA Department of Revenue при необходимости).' },
        q6: { q: 'Помогаете по вопросам WA Department of Revenue и L&I?', a: 'Да. Отчётность, уведомления, документы и коммуникация — чтобы вы соблюдали требования.' },
