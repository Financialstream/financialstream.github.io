  ...
  const i18n = {
    en: {
      ...
      cta: {
        ...
        ctaText: 'Book a free consultation or send a request — we’ll reply shortly with the next step.',
      ...
      faq: {
        ...
        q1: { q: 'What do you need from me to get started?', a: 'We’ll ask a few questions and request access to your bookkeeping platform, plus the key documents we need to begin.' },
        ...
        q8: { q: 'How fast do you respond?', a: 'Typically within 1 business day. Complex cases may take longer — we’ll keep you updated along the way.' },
        q9: { q: 'How much does it cost?', a: 'Pricing depends on volume and complexity. We’ll provide a clear quote after a short call.' },
      },
      contact: {
        title: 'Contact',
        subtitle: 'Tell us your goal and timeline — we will reply with a clear next step.',
        formTitle: 'Book a free consultation or ask a question',
        formSub: 'We’ll review your situation, ask a few quick questions, and suggest the next best step.',
        phone: 'Phone',
        email: 'Email',
        website: 'Website',
